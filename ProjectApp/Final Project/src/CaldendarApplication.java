...
public class CaldendarApplication 
{
	...
	public static void main(String[] args) 
	{
		EventQueue.invokeLater(new Runnable() 
		{
			...
			{
				try {
					CaldendarApplication window = new CaldendarApplication();
...
//no need for logic to figure out day, import already knows this. this object taps into the import to get the info
	...
	private void initialize() 
	{
		...
		btnPrevious.setBounds(10, 29, 73, 23);
		...
		btnNext.setBounds(169, 29, 66, 23);
		panel.add(btnNext);
